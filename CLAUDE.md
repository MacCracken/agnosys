...
- **Feature-gate everything** — consumers pull only what they need.
- **tracing on all kernel operations** — structured logging for audit trail.
...
- Do not add unnecessary dependencies — this is a kernel interface, keep it lean
